...
- **استخراج المنتجات حسب العلامة التجارية** - اكتشاف تلقائي للعلامات التجارية واستخراج المنتجات حسب العلامة المختارة
...
- **Python 3** + pandas + openpyxl - تنظيف ملفات Excel واستخراج المنتجات حسب العلامة التجارية
...
1. **الانتقال لصفحة الاستخراج**
   - من الصفحة الرئيسية، انقر على "استخراج المنتجات حسب العلامة التجارية"

2. **اكتشاف العلامات التجارية**
   - انقر على "اختيار ملف" واختر ملف Excel الذي يحتوي على المنتجات
   - انقر على "اكتشاف العلامات التجارية"
   - سيقوم النظام تلقائيًا بـ:
     - تحليل عمود "المنتج" في الملف
     - اكتشاف أسماء العلامات التجارية الأكثر تكرارًا
     - عرض العلامات مع عدد المنتجات لكل علامة

3. **اختيار العلامات واستخراج المنتجات**
   - اختر العلامات التجارية التي تريد استخراجها (يمكنك اختيار أكثر من علامة)
   - استخدم أزرار "تحديد الكل" أو "إلغاء تحديد الكل" للتحكم السريع
   - انقر على "استخراج المنتجات"
   - سيتم إنشاء ملف جديد يحتوي فقط على المنتجات من العلامات المختارة
   - الملف الجديد سيحتفظ بجميع الأعمدة والتنسيقات من الملف الأصلي
